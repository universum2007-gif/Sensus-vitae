...
const copy = {
  ru:{name:"Имя",email:"Электронная почта",topic:"Тема",message:"Сообщение",nameHint:"Как к вам обращаться?",emailHint:"Чтобы я могла ответить",topicHint:"Вопрос, материал или сотрудничество",messageHint:"Напишите ваш вопрос или предложение…",privacyNotice:"Отправленные данные используются для ответа. Сообщение сохраняется в контактной системе сайта, а доставка уведомления выполняется через почтового провайдера.",privacyLink:"Подробнее в Политике конфиденциальности.",consent:"Я согласен(на), что мои данные будут использованы только для ответа на это сообщение.",send:"Отправить",sending:"Отправляю…",successTitle:"Сообщение успешно отправлено",success:"Спасибо! Я получила ваше сообщение и смогу ответить по указанной электронной почте.",errorTitle:"Сообщение не отправлено",error:"Не удалось отправить сообщение. Проверьте соединение и попробуйте ещё раз."},
  es:{name:"Nombre",email:"Correo electrónico",topic:"Asunto",message:"Mensaje",nameHint:"¿Cómo te llamas?",emailHint:"Para poder responderte",topicHint:"Pregunta, material o colaboración",messageHint:"Escribe tu pregunta o propuesta…",privacyNotice:"Los datos enviados se utilizan para responder. El mensaje se guarda en el sistema de contacto del sitio y la notificación se entrega mediante el proveedor de correo electrónico.",privacyLink:"Más información en la Política de privacidad.",consent:"Acepto que mis datos se utilicen únicamente para responder a este mensaje.",send:"Enviar",sending:"Enviando…",successTitle:"Mensaje enviado correctamente",success:"¡Gracias! He recibido tu mensaje y podré responder al correo indicado.",errorTitle:"El mensaje no se ha enviado",error:"No se pudo enviar el mensaje. Comprueba la conexión e inténtalo de nuevo."},
  en:{name:"Name",email:"Email",topic:"Subject",message:"Message",nameHint:"How should I address you?",emailHint:"So I can reply",topicHint:"Question, study material or collaboration",messageHint:"Write your question or idea…",privacyNotice:"The information you submit is used to respond. Your message is stored in the site’s contact system, and the notification is delivered through the email provider.",privacyLink:"Read more in the Privacy Policy.",consent:"I agree that my details may be used only to reply to this message.",send:"Send message",sending:"Sending…",successTitle:"Message sent successfully",success:"Thank you! I have received your message and can reply to the email address provided.",errorTitle:"Message not sent",error:"The message could not be sent. Check your connection and try again."},
  nl:{name:"Naam",email:"E-mail",topic:"Onderwerp",message:"Bericht",nameHint:"Hoe mag ik je aanspreken?",emailHint:"Zodat ik kan antwoorden",topicHint:"Vraag, studiemateriaal of samenwerking",messageHint:"Schrijf je vraag of voorstel…",privacyNotice:"De verstrekte gegevens worden gebruikt om te antwoorden. Het bericht wordt opgeslagen in het contactsysteem van de site en de melding wordt bezorgd via de e-mailprovider.",privacyLink:"Lees meer in de Privacyverklaring.",consent:"Ik ga ermee akkoord dat mijn gegevens alleen worden gebruikt om op dit bericht te antwoorden.",send:"Versturen",sending:"Versturen…",successTitle:"Bericht succesvol verzonden",success:"Bedankt! Ik heb je bericht ontvangen en kan antwoorden via het opgegeven e-mailadres.",errorTitle:"Bericht niet verzonden",error:"Het bericht kon niet worden verzonden. Controleer je verbinding en probeer het opnieuw."},
} as const;
...
export function ContactForm({ lang }: { lang: Language }) {
  ...
  return <form onSubmit={submit} className="paper-card space-y-5 rounded-[1.5rem] border bg-card p-6 sm:p-8">
    ...
    <p className="rounded-xl border bg-[#faf7f0] p-4 text-sm leading-6 text-muted-foreground">{t.privacyNotice} <Link href={`/${lang}/privacy`} className="font-bold text-[#174f3c] underline decoration-[#b99850] underline-offset-4">{t.privacyLink}</Link></p>
