...
export default async function LibraryPage({ params }: { params: Promise<{ lang: string }> }) {
  ...
  const book = {
    ru:["Книжный клуб · Роберт Сапольски","Почему у зебр не бывает инфаркта","Конспекты глав 1–8: стрессовая реакция, гормоны, сердце, обмен веществ, пищеварение, рост, репродукция и иммунитет.","Открыть главы"],
    es:["Club de lectura · Robert Sapolsky","¿Por qué las cebras no tienen úlcera?","Capítulos 1–8: respuesta de estrés, hormonas, corazón, metabolismo, digestión, crecimiento, reproducción e inmunidad.","Abrir capítulos"],
    en:["Book club · Robert Sapolsky","Why Zebras Don’t Get Ulcers","Chapters 1–8: stress response, hormones, heart, metabolism, digestion, growth, reproduction and immunity.","Open chapters"],
    nl:["Boekenclub · Robert Sapolsky","Waarom krijgen zebra’s geen maagzweren?","Hoofdstukken 1–8: stressreactie, hormonen, hart, stofwisseling, spijsvertering, groei, voortplanting en immuniteit.","Open hoofdstukken"]
  }[lang];
