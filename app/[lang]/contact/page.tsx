...
const copy={
  ...
  es:{eyebrow:"CONTACTO",title:"Compartamos conocimiento",intro:"¿Tienes una pregunta, un artículo útil, una presentación o una idea para colaborar? Escríbeme. Me encantará conversar con otros estudiantes y personas interesadas en la psicología y la ciencia.",points:[["Preguntas","Dudas y conversación sobre los materiales publicados."],["Compartir materiales","Artículos, presentaciones, apuntes y recursos de estudio."],["Colaboración","Ideas para el club, análisis conjuntos y proyectos estudiantiles."]]},
  en:{eyebrow:"GET IN TOUCH",title:"Let’s share knowledge",intro:"Have a question, a useful article, a presentation or an idea for collaboration? Write to me. I welcome dialogue with fellow students and everyone interested in psychology and science.",points:[["Questions","Clarifications and discussion about published materials."],["Share materials","Articles, presentations, notes and useful study resources."],["Collaboration","Ideas for the club, joint reviews and student projects."]]},
