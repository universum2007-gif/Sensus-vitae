...
const copy = {
  ru: {
    ...
    items: [
      ["UNED Subjects", "Темы, связанные с учебной программой, фундаментальными понятиями и вопросами, которые помогают выстраивать программу обучения."],
      ["Chapter Summaries", "Краткие и структурированные резюме глав, чтобы связать идеи, механизмы и научное обоснование в единый контекст."],
      ["Learning Materials", "Собранные заметки, объяснения и связки между темами для более глубокого и устойчивого понимания."],
      ["Quizzes / Knowledge Checks", "Минимальные проверки понимания для закрепления ключевых идей без перегрузки и без искусственной сложности."],
